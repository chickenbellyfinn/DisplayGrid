...
public class FRCMatchResultsServerApp extends ServerApp implements UserStreamListener {
    ...
    private final String CONSUMER_KEY = "[consumer key here]";
    private final String CONSUMER_SECRET = "[consumer secret here]";
    private final String ACCESS_TOKEN = "[access token here]";
    private final String ACCESS_TOKEN_SECRET = "[access token secret here]";
